...
export type DockPanelId = 'timeline' | 'graph' | 'canvas' | 'reader'
export type DockMode = 'fullscreen' | 'floating'

export const DOCK_PANEL_IDS: DockPanelId[] = ['timeline', 'graph', 'canvas', 'reader']
...
export const DEFAULT_DOCK_PREFS: Record<DockPanelId, { geometry: DockGeometry }> = {
  ...
  reader: { geometry: defaultFloatingGeometry() },
}
